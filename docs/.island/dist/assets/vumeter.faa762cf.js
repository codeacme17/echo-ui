import{jsx as r,jsxs as t,Fragment as i}from"react/jsx-runtime";import{C as a}from"./CodeBlock.913859b9.js";import{D as s,H as d,S as l,C as m,L as c,a as u,V as h}from"./VuMeter.366dfad4.js";import"react";import"./index.c8ea1d61.js";import"../client-entry.js";import"./chunk-FXLYF44B.f49f16be.js";import"react-dom";import"./index.5a6550a4.js";import"./Meter.a572c499.js";import"./Analyser.93bf318f.js";const y=void 0,P=[{id:"import",text:"Import",depth:2},{id:"usage",text:"Usage",depth:2},{id:"horizontal-mode",text:"Horizontal Mode",depth:3},{id:"stereo-mode",text:"Stereo Mode",depth:3},{id:"compact-mode",text:"Compact Mode",depth:3},{id:"number-of-volume-bars",text:"Number of Volume Bars",depth:3},{id:"custom-colors",text:"Custom Colors",depth:3},{id:"data-tags",text:"Data Tags",depth:2},{id:"lump",text:"lump",depth:3},{id:"api",text:"API",depth:2},{id:"vu-meter",text:"VU Meter",depth:3},{id:"type-declarations",text:"Type Declarations",depth:2}],H="VU Meter";function o(n){const e=Object.assign({h1:"h1",a:"a",h2:"h2",h3:"h3",p:"p",code:"code",ul:"ul",li:"li"},n.components);return t(i,{children:[t(e.h1,{id:"vu-meter",children:[r(e.a,{className:"header-anchor","aria-hidden":"true",href:"#vu-meter",children:"#"}),"VU Meter"]}),`
...
`})]})}function D(n={}){const{wrapper:e}=n.components||{};return e?r(e,Object.assign({},n,{children:r(o,n)})):o(n)}const S="2024/1/14 18:54:17",N=`import { CodeBlock } from '../../src/components/CodeBlock.tsx'\r
import {\r
  Default,\r
  Horizontal,\r
  Lumps,\r
...
\r
>\r
`;export{N as content,D as default,y as frontmatter,S as lastUpdatedTime,H as title,P as toc};
