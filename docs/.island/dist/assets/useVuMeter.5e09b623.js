...
`]}),`
`]})]})}function g(i={}){const{wrapper:e}=i.components||{};return e?n(e,Object.assign({},i,{children:n(t,i)})):t(i)}const f="2024/1/18 22:27:49",v=`import { CodeBlock } from '../../src/components/CodeBlock.tsx'
...
- **meter**: [\`Tone.Meter | Tone.Split\`](https://tonejs.github.io/docs/14.7.77/Meter)
  ...
  \u6784\u5EFA\u7684\u7684 Tone.Meter \u6216 Tone.Split \u5B9E\u4F8B

- **value**: \`number | number[]\`

  \u5F53\u524D\u7684\u97F3\u91CF\u503C\uFF0C\u53EF\u4EE5\u81EA\u884C\u5B9A\u65F6\u901A\u8FC7 \`getValue\` \u83B7\u53D6\u6216\u8005\u4F7F\u7528 \`observe\` \u65B9\u6CD5\u81EA\u52A8\u5316\u5F00\u542F\u76D1\u542C
