import{jsx as r,jsxs as n,Fragment as a}from"react/jsx-runtime";import{C as d}from"./CodeBlock.f3a900da.js";import{l as i,G as h}from"./github.e4a0b0ac.js";import"react";const f=void 0,u=[{id:"\u5F15\u5165",text:"\u5F15\u5165",depth:2},{id:"\u4F20\u53C2",text:"\u4F20\u53C2",depth:2},{id:"usewaveformprops",text:"UseWaveformProps",depth:3},{id:"\u8FD4\u56DE\u503C",text:"\u8FD4\u56DE\u503C",depth:2},{id:"object",text:"Object",depth:3}],p="useWaveform";function o(c){const e=Object.assign({h1:"h1",a:"a",code:"code",p:"p",h2:"h2",h3:"h3",ul:"ul",li:"li",strong:"strong"},c.components);return n(a,{children:[n(e.h1,{id:"usewaveform",children:[r(e.a,{className:"header-anchor","aria-hidden":"true",href:"#usewaveform",children:"#"}),r(e.code,{children:"useWaveform"})]}),`
`,n(e.p,{children:["\u7528\u8BE5 Hook \u53EF\u4EE5\u83B7\u53D6\u97F3\u9891\u6587\u4EF6\u7684\u6CE2\u5F62\u6570\u636E\uFF0C\u5E76\u4E0E ",r(e.code,{children:"Waveform"})," \u7EC4\u4EF6\u914D\u5408\u4F7F\u7528\uFF0C\u5B9E\u73B0\u97F3\u9891\u6CE2\u5F62\u7684\u53EF\u89C6\u5316"]}),`
`,n(i,{href:"https://github.com/codeacme17/echo-ui/blob/main/packages/hooks/useWaveform.ts",target:"_blank",size:"sm",className:"flex items-center",children:[r(h,{className:"w-4 h-4"}),r("span",{className:"ml-2",children:"\u67E5\u770B\u6E90\u7801"})]}),`
...
`,n(e.ul,{children:[`
`,n(e.li,{children:[`
`,n(e.p,{children:[r(e.strong,{children:"arrayBuffer"}),"(\u5FC5\u4F20): ",r(e.code,{children:"ArrayBuffer"})]}),`
`,r(e.p,{children:"\u97F3\u9891\u6587\u4EF6\u7684 ArrayBuffer \u6570\u636E"}),`
`]}),`
`,n(e.li,{children:[`
...
`,r(e.p,{children:"\u9519\u8BEF\u4FE1\u606F"}),`
`]}),`
`]})]})}function b(c={}){const{wrapper:e}=c.components||{};return e?r(e,Object.assign({},c,{children:r(o,c)})):o(c)}const g="2024/1/16 20:29:14",v=`import { CodeBlock } from '../../src/components/CodeBlock.tsx'\r
...
### \`UseWaveformProps\`\r
\r
- **arrayBuffer**(\u5FC5\u4F20): \`ArrayBuffer\`\r
\r
  \u97F3\u9891\u6587\u4EF6\u7684 ArrayBuffer \u6570\u636E\r
\r
- **channel**: \`1 | 2\`\r
\r
  \u97F3\u9891\u6587\u4EF6\u7684\u58F0\u9053\u6570\uFF0C\u9ED8\u8BA4\u4E3A \`2\`\r
...
\r
  \u9519\u8BEF\u4FE1\u606F\r
`;export{v as content,b as default,f as frontmatter,g as lastUpdatedTime,p as title,u as toc};
