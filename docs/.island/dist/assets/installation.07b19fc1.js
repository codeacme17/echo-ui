import{jsx as e,jsxs as o,Fragment as d}from"react/jsx-runtime";import{M as t}from"./ManagerSwitch.db2a088f.js";import{C as c}from"./CodeBlock.d8e569ad.js";import"./chunk-FXLYF44B.3661c596.js";import"./index.93441784.js";import"react";import"react-dom";const p=void 0,g=[{id:"1-install-dependencies",text:"1. Install Dependencies",depth:3},{id:"2-tailwind-css-setup",text:"2. Tailwind CSS Setup",depth:3},{id:"3-import-css-variables",text:"3. Import CSS Variables",depth:3},{id:"4-import-components",text:"4. Import Components",depth:3}],b="Installation";function a(n){const r=Object.assign({h1:"h1",a:"a",p:"p",ul:"ul",li:"li",h3:"h3",code:"code"},n.components);return o(d,{children:[o(r.h1,{id:"installation",children:[e(r.a,{className:"header-anchor","aria-hidden":"true",href:"#installation",children:"#"}),"Installation"]}),`
`,e(r.p,{children:"Requirements:"}),`
`,o(r.ul,{children:[`
`,o(r.li,{children:[`
`,o(r.p,{children:[e(r.a,{href:"https://reactjs.org/",target:"_blank",rel:"nofollow",children:"React 18"})," or higher"]}),`
`]}),`
`,o(r.li,{children:[`
`,o(r.p,{children:[e(r.a,{href:"https://tailwindcss.com/",target:"_blank",rel:"nofollow",children:"Tailwind CSS 3"})," or higher"]}),`
`]}),`
`]}),`
`,o(r.h3,{id:"1-install-dependencies",children:[e(r.a,{className:"header-anchor","aria-hidden":"true",href:"#1-install-dependencies",children:"#"}),"1. Install Dependencies"]}),`
`,e(t,{npm:"npm install @nafr/echo-ui",yarn:"yarn add @nafr/echo-ui",pnpm:"pnpm add @nafr/echo-ui"}),`
`,o(r.h3,{id:"2-tailwind-css-setup",children:[e(r.a,{className:"header-anchor","aria-hidden":"true",href:"#2-tailwind-css-setup",children:"#"}),"2. Tailwind CSS Setup"]}),`
`,o(r.p,{children:["echo-ui is built on top of Tailwind CSS, so you need to install Tailwind CSS first. You can follow the official ",e(r.a,{href:"https://tailwindcss.com/docs/installation",target:"_blank",rel:"nofollow",children:"installation guide"})," for Tailwind CSS. Then you need to add the following code to your ",e(r.code,{children:"tailwind.config.js"})," file:"]}),`
`,e("br",{}),`
...
`}),`
`,o(r.h3,{id:"3-import-css-variables",children:[e(r.a,{className:"header-anchor","aria-hidden":"true",href:"#3-import-css-variables",children:"#"}),"3. Import CSS Variables"]}),`
`,e(r.p,{children:"Import echo-ui CSS variables in your main CSS file:"}),`
`,e("br",{}),`
`,e(c,{code:`/* index.css */
...
`,o(r.h3,{id:"4-import-components",children:[e(r.a,{className:"header-anchor","aria-hidden":"true",href:"#4-import-components",children:"#"}),"4. Import Components"]}),`
`,e(r.p,{children:"Import echo-ui components in your React components:"}),`
...
}`})]})}function v(n={}){const{wrapper:r}=n.components||{};return r?e(r,Object.assign({},n,{children:e(a,n)})):a(n)}const w="2024/3/15 11:12:17",y=`import { ManagerSwitch } from '../../src/components/ManagerSwitch.tsx'\r
...
module.exports = {\r
  content: [\r
    // ...\r
    "./node_modules/@nextui-/theme/dist/**/*.{js,ts,jsx,tsx}",\r
  ],\r
  theme: {\r
    extend: {\r
      colors: {\r
