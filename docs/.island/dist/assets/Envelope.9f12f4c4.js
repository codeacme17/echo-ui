import{jsx as n,jsxs as r,Fragment as i}from"react/jsx-runtime";import{C as o}from"./CodeBlock.3473f527.js";import{D as l,A as d,a as p,E as c}from"./Envelope.1ca6b328.js";import"react-dom";import"react";import"./index.5a6550a4.js";import"./index.1dc66bc0.js";import"../client-entry.js";const E=void 0,y=[{id:"import",text:"Import",depth:2},{id:"usage",text:"Usage",depth:2},{id:"ahdsr-envelope",text:"AHDSR Envelope",depth:3},{id:"delay",text:"Delay",depth:3},{id:"api",text:"API",depth:2},{id:"envelope",text:"Envelope",depth:3},{id:"type-declarations",text:"Type Declarations",depth:2}],A="Envelope";function a(t){const e=Object.assign({h1:"h1",a:"a",p:"p",h2:"h2",h3:"h3",code:"code"},t.components);return r(i,{children:[r(e.h1,{id:"envelope",children:[n(e.a,{className:"header-anchor","aria-hidden":"true",href:"#envelope",children:"#"}),"Envelope"]}),`
...
`})]})}function x(t={}){const{wrapper:e}=t.components||{};return e?n(e,Object.assign({},t,{children:n(a,t)})):a(t)}const g="2024/1/15 18:45:10",R=`import { CodeBlock } from '../../src/components/CodeBlock.tsx'\r
...
\`} />\r
`;export{R as content,x as default,E as frontmatter,g as lastUpdatedTime,A as title,y as toc};
