import{jsx as n,jsxs as r,Fragment as c}from"react/jsx-runtime";import{C as d}from"./CodeBlock.913859b9.js";import{l as h,G as t}from"./github.6e7f8090.js";import"react";const p=void 0,f=[{id:"\u5F15\u5165",text:"\u5F15\u5165",depth:2},{id:"\u4F20\u53C2",text:"\u4F20\u53C2",depth:2},{id:"usefetchaudioprops",text:"UseFetchAudioProps",depth:3},{id:"\u8FD4\u56DE\u503C",text:"\u8FD4\u56DE\u503C",depth:2},{id:"object",text:"Object",depth:3}],m="useFetchAudio";function o(i){const e=Object.assign({h1:"h1",a:"a",code:"code",p:"p",h2:"h2",h3:"h3",ul:"ul",li:"li",strong:"strong"},i.components);return r(c,{children:[r(e.h1,{id:"usefetchaudio",children:[n(e.a,{className:"header-anchor","aria-hidden":"true",href:"#usefetchaudio",children:"#"}),n(e.code,{children:"useFetchAudio"})]}),`
`,n(e.p,{children:"\u7528\u4E8E\u8BF7\u6C42\u97F3\u9891\u6570\u636E\u7684 Hook, \u8FD4\u56DE\u4E00\u4E2A\u5BF9\u8C61\uFF0C\u5305\u542B\u8BF7\u6C42\u7684\u72B6\u6001\u548C\u97F3\u9891\u6570\u636E"}),`
`,r(h,{href:"https://github.com/codeacme17/echo-ui/blob/main/packages/hooks/useFetchAudio.ts",target:"_blank",size:"sm",className:"flex items-center",children:[n(t,{className:"w-4 h-4"}),n("span",{className:"ml-2",children:"\u67E5\u770B\u6E90\u7801"})]}),`
...
`,r(e.p,{children:["\u8BF7\u6C42\u6210\u529F\u65F6\u7684\u56DE\u8C03\u51FD\u6570\uFF0C\u6B64\u65F6 ",n(e.code,{children:"audioBuffer"})," \u5DF2\u7ECF\u88AB\u6210\u529F\u89E3\u7801"]}),`
`]}),`
`,r(e.li,{children:[`
`,r(e.p,{children:[n(e.strong,{children:"onError"}),": ",n(e.code,{children:"() => void"})]}),`
`,n(e.p,{children:"\u8BF7\u6C42\u51FA\u9519\u65F6\u7684\u56DE\u8C03\u51FD\u6570"}),`
`]}),`
`]}),`
...
`,n(e.p,{children:"\u8BF7\u6C42\u97F3\u9891\u6570\u636E\u7684\u65B9\u6CD5\uFF0C\u8C03\u7528\u540E\u4F1A\u53D1\u8D77\u8BF7\u6C42"}),`
`]}),`
`,r(e.li,{children:[`
...
`]}),`
`]})]})}function g(i={}){const{wrapper:e}=i.components||{};return e?n(e,Object.assign({},i,{children:n(o,i)})):o(i)}const b="2024/1/24 14:13:17",A=`import { CodeBlock } from '../../src/components/CodeBlock.tsx'\r
...
- **onSuccess**: \`() => void\`\r
\r
  \u8BF7\u6C42\u6210\u529F\u65F6\u7684\u56DE\u8C03\u51FD\u6570\uFF0C\u6B64\u65F6 \`audioBuffer\` \u5DF2\u7ECF\u88AB\u6210\u529F\u89E3\u7801\r
\r
- **onError**: \`() => void\`\r
\r
  \u8BF7\u6C42\u51FA\u9519\u65F6\u7684\u56DE\u8C03\u51FD\u6570\r
...
\r
  \u8BF7\u6C42\u7684\u5B8C\u6574\u54CD\u5E94\r
`;export{A as content,g as default,p as frontmatter,b as lastUpdatedTime,m as title,f as toc};
