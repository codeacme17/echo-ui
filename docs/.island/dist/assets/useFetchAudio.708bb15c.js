import{jsx as r,jsxs as n,Fragment as i}from"react/jsx-runtime";import{C as c}from"./CodeBlock.f3a900da.js";import{l as d,G as h}from"./github.e4a0b0ac.js";import"react";const p=void 0,m=[{id:"import",text:"Import",depth:2},{id:"parameters",text:"Parameters",depth:2},{id:"usefetchaudioprops",text:"UseFetchAudioProps",depth:3},{id:"return-value",text:"Return Value",depth:2},{id:"object",text:"Object",depth:3}],f="useFetchAudio";function o(t){const e=Object.assign({h1:"h1",a:"a",code:"code",p:"p",h2:"h2",h3:"h3",ul:"ul",li:"li",strong:"strong"},t.components);return n(i,{children:[n(e.h1,{id:"usefetchaudio",children:[r(e.a,{className:"header-anchor","aria-hidden":"true",href:"#usefetchaudio",children:"#"}),r(e.code,{children:"useFetchAudio"})]}),`
...
`]}),`
`]})]})}function g(t={}){const{wrapper:e}=t.components||{};return e?r(e,Object.assign({},t,{children:r(o,t)})):o(t)}const b="2024/1/17 09:08:44",q=`import { CodeBlock } from '../../src/components/CodeBlock.tsx'\r
