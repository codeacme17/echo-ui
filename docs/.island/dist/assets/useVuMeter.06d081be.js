import{jsx as n,jsxs as r,Fragment as c}from"react/jsx-runtime";import{C as o}from"./CodeBlock.913859b9.js";import{l as d,G as l}from"./github.6e7f8090.js";import"react";const m=void 0,p=[{id:"\u5F15\u5165",text:"\u5F15\u5165",depth:2},{id:"\u4F20\u53C2",text:"\u4F20\u53C2",depth:2},{id:"usevumeterprops",text:"UseVuMeterProps",depth:3},{id:"\u8FD4\u56DE\u503C",text:"\u8FD4\u56DE\u503C",depth:2},{id:"object",text:"Object",depth:3}],b="useVuMeter";function t(i){const e=Object.assign({h1:"h1",a:"a",code:"code",p:"p",h2:"h2",h3:"h3",ul:"ul",li:"li",strong:"strong"},i.components);return r(c,{children:[r(e.h1,{id:"usevumeter",children:[n(e.a,{className:"header-anchor","aria-hidden":"true",href:"#usevumeter",children:"#"}),n(e.code,{children:"useVuMeter"})]}),`
`,n(e.p,{children:"\u7528\u4E8E\u83B7\u53D6\u97F3\u9891\u97F3\u91CF\u7684 Hook"}),`
`,r(d,{href:"https://github.com/codeacme17/echo-ui/blob/main/packages/hooks/useVuMeter.ts",target:"_blank",size:"sm",className:"flex items-center",children:[n(l,{className:"w-4 h-4"}),n("span",{className:"ml-2",children:"\u67E5\u770B\u6E90\u7801"})]}),`
...
`,n(e.p,{children:"\u6784\u5EFA\u7684\u7684 Tone.Meter \u6216 Tone.Split \u5B9E\u4F8B"}),`
`]}),`
`,r(e.li,{children:[`
`,r(e.p,{children:[n(e.strong,{children:"value"}),": ",n(e.code,{children:"number | number[]"})]}),`
`,r(e.p,{children:["\u5F53\u524D\u7684\u97F3\u91CF\u503C\uFF0C\u53EF\u4EE5\u81EA\u884C\u5B9A\u65F6\u901A\u8FC7 ",n(e.code,{children:"getValue"})," \u83B7\u53D6\u6216\u8005\u4F7F\u7528 ",n(e.code,{children:"observe"})," \u65B9\u6CD5\u81EA\u52A8\u5316\u5F00\u542F\u76D1\u542C"]}),`
`]}),`
`,r(e.li,{children:[`
...
`]}),`
`]})]})}function g(i={}){const{wrapper:e}=i.components||{};return e?n(e,Object.assign({},i,{children:n(t,i)})):t(i)}const f="2024/1/18 22:27:49",v=`import { CodeBlock } from '../../src/components/CodeBlock.tsx'\r
...
### \`Object\`\r
\r
- **meter**: [\`Tone.Meter | Tone.Split\`](https://tonejs.github.io/docs/14.7.77/Meter)\r
\r
  \u6784\u5EFA\u7684\u7684 Tone.Meter \u6216 Tone.Split \u5B9E\u4F8B\r
\r
- **value**: \`number | number[]\`\r
\r
  \u5F53\u524D\u7684\u97F3\u91CF\u503C\uFF0C\u53EF\u4EE5\u81EA\u884C\u5B9A\u65F6\u901A\u8FC7 \`getValue\` \u83B7\u53D6\u6216\u8005\u4F7F\u7528 \`observe\` \u65B9\u6CD5\u81EA\u52A8\u5316\u5F00\u542F\u76D1\u542C\r
\r
- **getValue**: \`() => void\`\r
\r
