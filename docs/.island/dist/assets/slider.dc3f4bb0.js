...
export interface SliderRef extends HTMLDivElement {}`})]})}function L(i={}){const{wrapper:e}=i.components||{};return e?n(e,Object.assign({},i,{children:n(r,i)})):r(i)}const B="2024/1/23 17:02:29",R=`import { CodeBlock } from '../../src/components/CodeBlock.tsx'
import {
  Default,
  Disabled,
  Vertical,
