import{jsx as r,jsxs as n,Fragment as o}from"react/jsx-runtime";import{C as a}from"./CodeBlock.3473f527.js";import{D as i,a as h,S as s,C as d,G as l,b,c as p}from"./Checkbox.c79c3d61.js";import"react-dom";import"react";import"./index.1dc66bc0.js";import"../client-entry.js";const T=void 0,E=[{id:"import",text:"Import",depth:2},{id:"usage",text:"Usage",depth:2},{id:"disabled-state",text:"Disabled State",depth:3},{id:"size",text:"Size",depth:3},{id:"color",text:"Color",depth:3},{id:"checkbox-group",text:"Checkbox Group",depth:3},{id:"data-attributes",text:"Data Attributes",depth:2},{id:"api",text:"API",depth:2},{id:"checkbox",text:"Checkbox",depth:3},{id:"checkboxgroup",text:"Checkbox.Group",depth:3},{id:"type-declarations",text:"Type Declarations",depth:2}],M="Checkbox";function c(t){const e=Object.assign({h1:"h1",a:"a",h2:"h2",h3:"h3",ul:"ul",li:"li",code:"code",div:"div",p:"p"},t.components);return n(o,{children:[n(e.h1,{id:"checkbox",children:[r(e.a,{className:"header-anchor","aria-hidden":"true",href:"#checkbox",children:"#"}),"Checkbox"]}),`
...
export interface CheckboxGroupRef extends HTMLDivElement {}`})]})}function g(t={}){const{wrapper:e}=t.components||{};return e?r(e,Object.assign({},t,{children:r(c,t)})):c(t)}const P="2024/1/14 18:30:40",H=`import { CodeBlock } from '../../src/components/CodeBlock.tsx'\r
...
`;export{H as content,g as default,T as frontmatter,P as lastUpdatedTime,M as title,E as toc};
