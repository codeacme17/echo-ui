...
export interface SliderRef extends HTMLDivElement {}`})]})}function H(i={}){const{wrapper:e}=i.components||{};return e?n(e,Object.assign({},i,{children:n(r,i)})):r(i)}const U="2024/1/14 18:30:40",w=`import { CodeBlock } from '../../src/components/CodeBlock.tsx'
import {
  Default,
  Disabled,
  Vertical,
