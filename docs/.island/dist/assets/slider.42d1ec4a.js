import{jsx as r,jsxs as n,Fragment as d}from"react/jsx-runtime";import{C as i}from"./CodeBlock.913859b9.js";import{D as o,a as l,V as s,B as c,A as h,S as m,C as u,U as p,b}from"./Slider.7248493e.js";import{k as g}from"./chunk-GM3GRPI5.bc90fcd4.js";import"react";import"./index.bf22460a.js";import"../client-entry.js";import"./chunk-FXLYF44B.f49f16be.js";import"react-dom";import"./square.113dfb30.js";const P=void 0,D=[{id:"import",text:"Import",depth:2},{id:"usage",text:"Usage",depth:2},{id:"disabled-state",text:"Disabled State",depth:3},{id:"vertical-mode",text:"Vertical Mode",depth:3},{id:"bilateral-mode",text:"Bilateral Mode",depth:3},{id:"adding-coordinates",text:"Adding Coordinates",depth:3},{id:"step",text:"Step",depth:3},{id:"custom-styling",text:"Custom Styling",depth:3},{id:"uncontrolled-mode",text:"Uncontrolled Mode",depth:3},{id:"data-attributes",text:"Data Attributes",depth:2},{id:"api",text:"API",depth:2},{id:"slider",text:"Slider",depth:3},{id:"type-declarations",text:"Type Declarations",depth:2}],M="Slider";function a(t){const e=Object.assign({h1:"h1",a:"a",p:"p",code:"code",h2:"h2",div:"div",h3:"h3",ul:"ul",li:"li"},t.components);return n(d,{children:[n(e.h1,{id:"slider",children:[r(e.a,{className:"header-anchor","aria-hidden":"true",href:"#slider",children:"#"}),"Slider"]}),`
...
export interface SliderRef extends HTMLDivElement {}`})]})}function L(t={}){const{wrapper:e}=t.components||{};return e?r(e,Object.assign({},t,{children:r(a,t)})):a(t)}const B="2024/1/23 17:02:29",R=`import { CodeBlock } from '../../src/components/CodeBlock.tsx'\r
import {\r
  Default,\r
  Disabled,\r
  Vertical,\r
...
`;export{R as content,L as default,P as frontmatter,B as lastUpdatedTime,M as title,D as toc};
