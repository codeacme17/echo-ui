...
`,n(l,{href:"https://github.com/codeacme17/echo-ui/blob/main/packages/hooks/useVuMeter.ts",target:"_blank",size:"sm",className:"flex items-center",children:[r(c,{className:"w-4 h-4"}),r("span",{className:"ml-2",children:"View Source Code"})]}),`
...
`,n(e.ul,{children:[`
`,n(e.li,{children:[`
`,n(e.p,{children:[r(e.strong,{children:"meter"}),": ",r(e.a,{href:"https://tonejs.github.io/docs/14.7.77/Meter",target:"_blank",rel:"nofollow",children:r(e.code,{children:"Tone.Meter | Tone.Split"})})]}),`
`,r(e.p,{children:"Constructed Tone.Meter or Tone.Split instance"}),`
`]}),`
`,n(e.li,{children:[`
...
`,r(e.p,{children:"Request error message"}),`
`]}),`
`]})]})}function g(t={}){const{wrapper:e}=t.components||{};return e?r(e,Object.assign({},t,{children:r(o,t)})):o(t)}const b="2024/1/18 22:27:49",f=`import { CodeBlock } from '../../src/components/CodeBlock.tsx'\r
...
\r
  Constructed Tone.Meter or Tone.Split instance\r
\r
