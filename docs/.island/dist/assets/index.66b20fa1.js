<<<<<<<< HEAD:docs/.island/dist/assets/index.66b20fa1.js
import{jsxs as ee,jsx as L}from"react/jsx-runtime";import{forwardRef as te,useImperativeHandle as re,useEffect as S,useState as E,useRef as $,useCallback as ae,useMemo as se}from"react";import{v as B,h as V,c as p}from"./index.b2cccce0.js";import{A as oe}from"./index.704bb6de.js";import{_ as ne}from"./assertion.e9357fda.js";import{l as C}from"./log.83f32a09.js";import{s as ie}from"./index.93441784.js";import{u as le}from"./useCommandAltClick.cec7174c.js";const ue=({value:d,min:h,max:i})=>{if(!!ne)return d>i&&C.warn(`Slider - value(${d}) is higher than max(${i})`),d<h&&C.warn(`Slider - value(${d}) is lower than min(${h})`),!0},de=ie({slots:{base:`group
========
import{jsxs as ee,jsx as L}from"react/jsx-runtime";import{forwardRef as te,useImperativeHandle as re,useEffect as S,useState as E,useRef as $,useCallback as ae,useMemo as se}from"react";import{v as B,h as V,c as p}from"./index.2440eb3f.js";import{A as oe}from"./index.3017822d.js";import{_ as ne}from"./assertion.e9357fda.js";import{l as C}from"./log.83f32a09.js";import{s as ie}from"./index.93441784.js";import{u as le}from"./useCommandAltClick.cec7174c.js";const ue=({value:d,min:h,max:i})=>{if(!!ne)return d>i&&C.warn(`Slider - value(${d}) is higher than max(${i})`),d<h&&C.warn(`Slider - value(${d}) is lower than min(${h})`),!0},de=ie({slots:{base:`group
>>>>>>>> main:docs/.island/dist/assets/index.d3240143.js
    text-foreground
    w-full
    h-2
    cursor-pointer
