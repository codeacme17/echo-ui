...
`,r(e.p,{children:["\u521D\u59CB\u5316\u540E\u6784\u5EFA\u7C7B\u578B\u4E3A ",n(e.code,{children:"waveform"})," \u7684\u5206\u6790\u5668 ",n(e.a,{href:"https://tonejs.github.io/docs/14.7.77/Analyser",target:"_blank",rel:"nofollow",children:"Tone.Analyser"})," \u5B9E\u4F8B"]}),`
`]}),`
`,r(e.li,{children:[`
...
`]}),`
`]})]})}function v(c={}){const{wrapper:e}=c.components||{};return e?n(e,Object.assign({},c,{children:n(o,c)})):o(c)}const k="2024/1/29 16:05:29",y=`import { CodeBlock } from '../../src/components/CodeBlock.tsx'\r
import { Chip, Link } from '@nextui-org/react'\r
import { Github } from 'lucide-react'\r
\r
# \`useOscilloscope\`\r
\r
\u7528\u4E8E\u521B\u5EFA\u4E00\u4E2A\u793A\u6CE2\u5668\u7684 hook\uFF0C\u53EF\u4EE5\u83B7\u53D6\u5230\u5B9E\u65F6\u7684\u632F\u5E45\u6570\u636E\r
\r
<Link\r
...
\r
  \u521D\u59CB\u5316\u540E\u6784\u5EFA\u7C7B\u578B\u4E3A \`waveform\` \u7684\u5206\u6790\u5668 [Tone.Analyser](https://tonejs.github.io/docs/14.7.77/Analyser) \u5B9E\u4F8B\r
\r
...
\r
  \u76D1\u542C\u793A\u6CE2\u5668\u6570\u636E\u7684\u53D8\u5316\uFF0C\u4F7F\u7528\u8BE5\u51FD\u6570\u53EF\u5F00\u542F\u76D1\u542C\uFF0C\u5E76\u5B9E\u65F6\u7684\u83B7\u5F97 data \u7684\u53D8\u5316\r
\r
...
\r
  \u51FA\u9519\u7684\u9519\u8BEF\u4FE1\u606F\r
`;export{y as content,v as default,g as frontmatter,k as lastUpdatedTime,f as title,b as toc};
