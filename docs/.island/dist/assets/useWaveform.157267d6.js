...
`,n(e.p,{children:["The number of audio channels in the audio file, defaults to ",r(e.code,{children:"2"}),". \xB7"]}),`
`]}),`
`,n(e.li,{children:[`
...
`]}),`
`,n(e.li,{children:[`
`,n(e.p,{children:[r(e.strong,{children:"audioDuration"}),": ",r(e.code,{children:"React.MutableRefObject<number>"})]}),`
`,n(e.p,{children:["The duration of the audio file is in seconds and needs to be obtained using ",r(e.code,{children:".current"})]}),`
`]}),`
`,n(e.li,{children:[`
...
`]}),`
`]})]})}function v(a={}){const{wrapper:e}=a.components||{};return e?r(e,Object.assign({},a,{children:r(o,a)})):o(a)}const w="2024/3/9 14:31:31",k=`import { CodeBlock } from '../../src/components/CodeBlock.tsx'\r
...
- **channel**: \`1 | 2\`\r
\r
  The number of audio channels in the audio file, defaults to \`2\`. \xB7\r
\r
- **samples**: \`number\`\r
\r
...
\r
  The duration of the audio file is in seconds and needs to be obtained using \`.current\`\r
\r
- **error**: \`boolean\`\r
\r
