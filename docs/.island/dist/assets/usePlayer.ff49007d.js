import{jsx as n,jsxs as r,Fragment as l}from"react/jsx-runtime";import{C as o}from"./CodeBlock.de027be4.js";import{G as c}from"./github.54c71331.js";import{l as d}from"./chunk-MPX6TMFQ.dc1d8ff0.js";import"react";import"./index.2d091e0a.js";const b=void 0,f=[{id:"import",text:"Import",depth:2},{id:"parameters",text:"Parameters",depth:2},{id:"useplayerprops",text:"UsePlayerProps",depth:3},{id:"return-values",text:"Return Values",depth:2},{id:"object",text:"Object",depth:3}],g="usePlayer";function t(i){const e=Object.assign({h1:"h1",a:"a",code:"code",p:"p",h2:"h2",h3:"h3",ul:"ul",li:"li",strong:"strong",div:"div"},i.components);return r(l,{children:[r(e.h1,{id:"useplayer",children:[n(e.a,{className:"header-anchor","aria-hidden":"true",href:"#useplayer",children:"#"}),n(e.code,{children:"usePlayer"})]}),`
...
`]}),`
`,r(e.li,{children:[`
`,r(e.p,{children:[n(e.strong,{children:"player"}),": ",n(e.code,{children:"React.MutableRefObject<Tone.Player | null>"})]}),`
`,r(e.p,{children:["The ",n(e.a,{href:"https://tonejs.github.io/docs/14.7.77/Player",target:"_blank",rel:"nofollow",children:"Tone.Player"})," instance created after initialization. Need to use ",n(e.code,{children:".current"})," to obtain."]}),`
`]}),`
`,r(e.li,{children:[`
`,r(e.p,{children:[n(e.strong,{children:"audioDuration"}),": ",n(e.code,{children:"React.MutableRefObject<number>"})]}),`
`,r(e.p,{children:["The duration of the audio in seconds. Need to use ",n(e.code,{children:".current"})," to obtain."]}),`
`]}),`
`,r(e.li,{children:[`
...
`]}),`
`]})]})}function y(i={}){const{wrapper:e}=i.components||{};return e?n(e,Object.assign({},i,{children:n(t,i)})):t(i)}const k="2024/1/31 15:22:24",v=`import { CodeBlock } from '../../src/components/CodeBlock.tsx'\r
...
\r
  The [Tone.Player](https://tonejs.github.io/docs/14.7.77/Player) instance created after initialization. Need to use \`.current\` to obtain.\r
\r
- **audioDuration**: \`React.MutableRefObject<number>\`\r
\r
  The duration of the audio in seconds. Need to use \`.current\` to obtain.\r
\r
- **isReady**: \`boolean\`\r
\r
