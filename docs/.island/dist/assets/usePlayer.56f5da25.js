...
`,e(n.p,{children:"\u9519\u8BEF\u4FE1\u606F"}),`
`]}),`
`]})]})}function f(i={}){const{wrapper:n}=i.components||{};return n?e(n,Object.assign({},i,{children:e(c,i)})):c(i)}const y="2024/1/22 12:01:10",v=`import { CodeBlock } from '../../src/components/CodeBlock.tsx'\r
...
- **chain**: \`AudioNode[]\`\r
\r
  \u97F3\u9891\u8282\u70B9\u94FE\uFF0C\u8FDE\u63A5\u7684\u8282\u70B9\u4F1A\u5728\u64AD\u653E\u65F6\u4F9D\u6B21\u6267\u884C\uFF0C**\u6CE8\u610F\u4E0D\u9700\u8981\u5728\u6700\u540E\u52A0\u5165 \`Tone.Destination\` \u8282\u70B9** \u3002\u5982\u4E0B\u4EE3\u7801\u6240\u793A\uFF0C\u8FDE\u63A5\u4E86\u4E00\u4E2A \`filter\` \u8282\u70B9\u548C\u4E00\u4E2A \`analyser\` \u8282\u70B9\r
\r
...
\r
  \u521D\u59CB\u5316\u540E\u6784\u5EFA\u7684 [Tone.Player](https://tonejs.github.io/docs/14.7.77/Player) \u5B9E\u4F8B\r
\r
...
\r
  \u9519\u8BEF\u4FE1\u606F\r
`;export{v as content,f as default,m as frontmatter,y as lastUpdatedTime,g as title,b as toc};
