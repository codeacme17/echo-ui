import{jsx as n,jsxs as t,Fragment as o}from"react/jsx-runtime";import{D as s,a as c,L as l}from"./LFO.d2787581.js";import{C as r}from"./CodeBlock.de027be4.js";import"./index.a54ae35d.js";import"./index.2d091e0a.js";import"react";import"../client-entry.js";import"./chunk-FXLYF44B.3b11858b.js";import"react-dom";import"./index.3fdeaba1.js";import"./pause.0e546ef8.js";import"./play.04387a46.js";import"./Filter.9ff151a0.js";const g=void 0,T=[{id:"import",text:"Import",depth:2},{id:"usage",text:"Usage",depth:2},{id:"delay",text:"Delay",depth:3},{id:"api",text:"API",depth:2},{id:"lfo",text:"LFO",depth:3},{id:"type-declarations",text:"Type Declarations",depth:2}],v="LFO";function i(a){const e=Object.assign({h1:"h1",a:"a",p:"p",h2:"h2",h3:"h3"},a.components);return t(o,{children:[t(e.h1,{id:"lfo",children:[n(e.a,{className:"header-anchor","aria-hidden":"true",href:"#lfo",children:"#"}),"LFO"]}),`
...
`,n(r,{code:"import { LFO } from 'echo-ui'"}),`
...
`,n(r,{code:`export interface LFOProps extends React.HTMLAttributes<HTMLDivElement> {
  frequency?: number
  amplitude?: number
  delay?: number
...
`})]})}function w(a={}){const{wrapper:e}=a.components||{};return e?n(e,Object.assign({},a,{children:n(i,a)})):i(a)}const C="2024/3/5 13:46:07",I=`import { Default, Delay } from '../../src/components/UsageBox/LFO.tsx'
