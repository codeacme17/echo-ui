import{jsx as t,jsxs as n,Fragment as o}from"react/jsx-runtime";import{C as a}from"./CodeBlock.3473f527.js";import{D as s,T as d,a as c,S as h,C as l,b as m}from"./Switch.26000905.js";import"react-dom";import"react";import"./index.1dc66bc0.js";import"../client-entry.js";const x=void 0,C=[{id:"import",text:"Import",depth:2},{id:"usage",text:"Usage",depth:2},{id:"toggled-state",text:"Toggled State",depth:3},{id:"disabled-state",text:"Disabled State",depth:3},{id:"size",text:"Size",depth:3},{id:"custom-styling",text:"Custom Styling",depth:3},{id:"api",text:"API",depth:2},{id:"switch",text:"Switch",depth:3},{id:"type-declarations",text:"Type Declarations",depth:2}],T="Switch";function i(r){const e=Object.assign({h1:"h1",a:"a",p:"p",h2:"h2",h3:"h3"},r.components);return n(o,{children:[n(e.h1,{id:"switch",children:[t(e.a,{className:"header-anchor","aria-hidden":"true",href:"#switch",children:"#"}),"Switch"]}),`
...
export interface SwitchRef extends HTMLLabelElement {}`})]})}function y(r={}){const{wrapper:e}=r.components||{};return e?t(e,Object.assign({},r,{children:t(i,r)})):i(r)}const D="2024/1/14 18:29:34",P=`import { CodeBlock } from '../../src/components/CodeBlock.tsx'\r
...
`;export{P as content,y as default,x as frontmatter,D as lastUpdatedTime,T as title,C as toc};
