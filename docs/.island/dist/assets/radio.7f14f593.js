...
`,n(r,{code:`interface AbstractRadioProps<T>
...
export interface RadioGroupRef extends HTMLDivElement {}`})]})}function A(t={}){const{wrapper:e}=t.components||{};return e?n(e,Object.assign({},t,{children:n(i,t)})):i(t)}const N="2024/3/15 13:46:55",D=`import { CodeBlock } from '../../src/components/CodeBlock.tsx'
