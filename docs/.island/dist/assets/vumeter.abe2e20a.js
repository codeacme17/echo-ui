import{jsx as t,jsxs as n,Fragment as i}from"react/jsx-runtime";import{C as a}from"./CodeBlock.69bc42b0.js";import{D as s,H as d,S as l,C as m,L as c,a as u,V as h}from"./VuMeter.3bf0a8f9.js";import"react";import"./index.25e4622b.js";import"../client-entry.js";import"./chunk-FXLYF44B.9f5da3e9.js";import"react-dom";import"./index.5a6550a4.js";import"./square.03af2c16.js";import"./Meter.45e0756d.js";import"./Analyser.93bf318f.js";const P=void 0,H=[{id:"import",text:"Import",depth:2},{id:"usage",text:"Usage",depth:2},{id:"horizontal-mode",text:"Horizontal Mode",depth:3},{id:"stereo-mode",text:"Stereo Mode",depth:3},{id:"compact-mode",text:"Compact Mode",depth:3},{id:"number-of-volume-bars",text:"Number of Volume Bars",depth:3},{id:"custom-colors",text:"Custom Colors",depth:3},{id:"data-tags",text:"Data Tags",depth:2},{id:"lump",text:"lump",depth:3},{id:"api",text:"API",depth:2},{id:"vu-meter",text:"VU Meter",depth:3},{id:"type-declarations",text:"Type Declarations",depth:2}],D="VU Meter";function o(r){const e=Object.assign({h1:"h1",a:"a",h2:"h2",h3:"h3",p:"p",code:"code",ul:"ul",li:"li"},r.components);return n(i,{children:[n(e.h1,{id:"vu-meter",children:[t(e.a,{className:"header-anchor","aria-hidden":"true",href:"#vu-meter",children:"#"}),"VU Meter"]}),`
`,n(e.h2,{id:"import",children:[t(e.a,{className:"header-anchor","aria-hidden":"true",href:"#import",children:"#"}),"Import"]}),`
`,t(a,{code:"import { VuMeter } from 'echo-ui'"}),`
...
`})]})}function S(r={}){const{wrapper:e}=r.components||{};return e?t(e,Object.assign({},r,{children:t(o,r)})):o(r)}const N="2024/1/14 18:54:17",A=`import { CodeBlock } from '../../src/components/CodeBlock.tsx'
import {
  Default,
  Horizontal,
  Lumps,
...
>
`;export{A as content,S as default,P as frontmatter,N as lastUpdatedTime,D as title,H as toc};
