import{jsx as r,jsxs as n,Fragment as i}from"react/jsx-runtime";import{C as c}from"./CodeBlock.f3a900da.js";import{l as d,G as t}from"./github.e4a0b0ac.js";import"react";const u=void 0,f=[{id:"import",text:"Import",depth:2},{id:"parameters",text:"Parameters",depth:2},{id:"usewaveformprops",text:"UseWaveformProps",depth:3},{id:"return-value",text:"Return Value",depth:2},{id:"object",text:"Object",depth:3}],p="useWaveform";function o(a){const e=Object.assign({h1:"h1",a:"a",code:"code",p:"p",h2:"h2",h3:"h3",ul:"ul",li:"li",strong:"strong"},a.components);return n(i,{children:[n(e.h1,{id:"usewaveform",children:[r(e.a,{className:"header-anchor","aria-hidden":"true",href:"#usewaveform",children:"#"}),r(e.code,{children:"useWaveform"})]}),`
`,r(e.p,{children:"This Hook allows you to fetch waveform data of an audio file."}),`
`,n(d,{href:"https://github.com/codeacme17/echo-ui/blob/main/packages/hooks/useWaveform.ts",target:"_blank",size:"sm",className:"flex items-center",children:[r(t,{className:"w-4 h-4"}),r("span",{className:"ml-2",children:"View Source"})]}),`
`,n(e.h2,{id:"import",children:[r(e.a,{className:"header-anchor","aria-hidden":"true",href:"#import",children:"#"}),"Import"]}),`
`,r(c,{code:"import { useWaveform, type UseWaveformProps } form 'echo-ui'"}),`
...
`,n(e.ul,{children:[`
`,n(e.li,{children:[`
`,n(e.p,{children:[r(e.strong,{children:"arrayBuffer"})," (required): ",r(e.code,{children:"ArrayBuffer"})]}),`
...
`]}),`
`]})]})}function b(a={}){const{wrapper:e}=a.components||{};return e?r(e,Object.assign({},a,{children:r(o,a)})):o(a)}const g="2024/1/16 20:29:14",v=`import { CodeBlock } from '../../src/components/CodeBlock.tsx'\r
...
### \`UseWaveformProps\`\r
\r
- **arrayBuffer** (required): \`ArrayBuffer\`\r
\r
