...
export interface SliderRef extends HTMLDivElement {}`})]})}function U(t={}){const{wrapper:e}=t.components||{};return e?r(e,Object.assign({},t,{children:r(a,t)})):a(t)}const w="2024/1/14 18:30:40",k=`import { CodeBlock } from '../../src/components/CodeBlock.tsx'\r
import {\r
  Default,\r
  Disabled,\r
  Vertical,\r
...
`;export{k as content,U as default,B as frontmatter,w as lastUpdatedTime,H as title,R as toc};
