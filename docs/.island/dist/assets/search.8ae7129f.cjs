...
var WeakMap$1 = getNative(ssrEntry.root, "WeakMap");
...
var Buffer = moduleExports$1 ? ssrEntry.root.Buffer : void 0;
...
if (DataView$1 && getTag(new DataView$1(new ArrayBuffer(1))) != dataViewTag$1 || Map$1 && getTag(new Map$1()) != mapTag$1 || Promise$2 && getTag(Promise$2.resolve()) != promiseTag || Set$1 && getTag(new Set$1()) != setTag$1 || WeakMap$2 && getTag(new WeakMap$2()) != weakMapTag) {
...
var Uint8Array = ssrEntry.root.Uint8Array;
...
_cjkIndex = /* @__PURE__ */ new WeakMap();
_headerToIdMap = /* @__PURE__ */ new WeakMap();
_langRoutePrefix = /* @__PURE__ */ new WeakMap();
_matchHeader = /* @__PURE__ */ new WeakSet();
...
_matchContent = /* @__PURE__ */ new WeakSet();
...
_normalizeStatement = /* @__PURE__ */ new WeakSet();
