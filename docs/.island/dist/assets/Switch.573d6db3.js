import{U as c,l as o,A as a,a as e}from"./index.7584db17.js";import{jsx as t}from"react/jsx-runtime";const l=()=>t(c,{code:"<Switch> Switch </Switch>",scope:{Switch:o}}),r=()=>t(c,{code:"<Switch toggled> Toggled </Switch>",scope:{Switch:o}}),h=()=>t(c,{code:"<Switch disabled> Disabled </Switch>",scope:{Switch:o}}),u=()=>t(c,{code:`<div className="flex gap-6 items-center">
