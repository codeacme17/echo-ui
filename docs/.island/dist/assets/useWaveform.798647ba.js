import{jsx as r,jsxs as n,Fragment as d}from"react/jsx-runtime";import{C as i}from"./CodeBlock.f3a900da.js";import{l as a,G as h}from"./github.e4a0b0ac.js";import"react";const u=void 0,f=[{id:"\u5F15\u5165",text:"\u5F15\u5165",depth:2},{id:"\u4F20\u53C2",text:"\u4F20\u53C2",depth:2},{id:"usewaveformprops",text:"UseWaveformProps",depth:3},{id:"\u8FD4\u56DE\u503C",text:"\u8FD4\u56DE\u503C",depth:2},{id:"object",text:"Object",depth:3}],p="useWaveform";function o(c){const e=Object.assign({h1:"h1",a:"a",code:"code",p:"p",h2:"h2",h3:"h3",ul:"ul",li:"li",strong:"strong"},c.components);return n(d,{children:[n(e.h1,{id:"usewaveform",children:[r(e.a,{className:"header-anchor","aria-hidden":"true",href:"#usewaveform",children:"#"}),r(e.code,{children:"useWaveform"})]}),`
...
`,r(i,{code:"import { useWaveform, type UseWaveformProps } form 'echo-ui'"}),`
...
`,r(e.p,{children:"\u9519\u8BEF\u4FE1\u606F"}),`
`]}),`
`]})]})}function b(c={}){const{wrapper:e}=c.components||{};return e?r(e,Object.assign({},c,{children:r(o,c)})):o(c)}const g="2024/1/17 09:08:44",v=`import { CodeBlock } from '../../src/components/CodeBlock.tsx'\r
