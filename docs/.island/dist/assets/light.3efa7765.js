import{jsx as t,jsxs as r,Fragment as o}from"react/jsx-runtime";import{D as h,O as c,C as d,S as s,L as l}from"./Light.c313cf6c.js";import{C as i}from"./CodeBlock.3473f527.js";import"./index.1dc66bc0.js";import"react";import"../client-entry.js";import"react-dom";const b=void 0,T=[{id:"import",text:"Import",depth:2},{id:"usage",text:"Usage",depth:2},{id:"on-state",text:"On State",depth:3},{id:"light-color",text:"Light Color",depth:3},{id:"size",text:"Size",depth:3},{id:"api",text:"API",depth:2},{id:"light",text:"Light",depth:3},{id:"type-declarations",text:"Type Declarations",depth:2}],C="Light";function a(n){const e=Object.assign({h1:"h1",a:"a",p:"p",h2:"h2",h3:"h3"},n.components);return r(o,{children:[r(e.h1,{id:"light",children:[t(e.a,{className:"header-anchor","aria-hidden":"true",href:"#light",children:"#"}),"Light"]}),`
...
export interface LightRef extends HTMLDivElement {}`})]})}function D(n={}){const{wrapper:e}=n.components||{};return e?t(e,Object.assign({},n,{children:t(a,n)})):a(n)}const z="2024/1/14 18:34:42",I=`import {\r
  DefaultLight,\r
  OnLight,\r
  ColorLight,\r
  SizeLight,\r
...
`;export{I as content,D as default,b as frontmatter,z as lastUpdatedTime,C as title,T as toc};
