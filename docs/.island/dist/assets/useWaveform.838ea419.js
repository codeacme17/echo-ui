import{jsx as r,jsxs as n,Fragment as i}from"react/jsx-runtime";import{C as d}from"./CodeBlock.988145ba.js";import{l as c,G as t}from"./github.204dd0d2.js";import"./createLucideIcon.6491784f.js";import"react";const f=void 0,p=[{id:"import",text:"Import",depth:2},{id:"parameters",text:"Parameters",depth:2},{id:"usewaveformprops",text:"UseWaveformProps",depth:3},{id:"return-value",text:"Return Value",depth:2},{id:"object",text:"Object",depth:3}],b="useWaveform";function o(a){const e=Object.assign({h1:"h1",a:"a",code:"code",p:"p",h2:"h2",h3:"h3",ul:"ul",li:"li",strong:"strong"},a.components);return n(i,{children:[n(e.h1,{id:"usewaveform",children:[r(e.a,{className:"header-anchor","aria-hidden":"true",href:"#usewaveform",children:"#"}),r(e.code,{children:"useWaveform"})]}),`
...
`]}),`
`]})]})}function g(a={}){const{wrapper:e}=a.components||{};return e?r(e,Object.assign({},a,{children:r(o,a)})):o(a)}const v="2024/1/17 09:08:44",w=`import { CodeBlock } from '../../src/components/CodeBlock.tsx'\r
...
\r
  The error message.\r
`;export{w as content,g as default,f as frontmatter,v as lastUpdatedTime,b as title,p as toc};
