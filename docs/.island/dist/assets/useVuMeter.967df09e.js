import{jsx as n,jsxs as r,Fragment as c}from"react/jsx-runtime";import{C as d}from"./CodeBlock.913859b9.js";import{l as t,G as l}from"./github.6e7f8090.js";import"react";const p=void 0,m=[{id:"\u5F15\u5165",text:"\u5F15\u5165",depth:2},{id:"\u4F20\u53C2",text:"\u4F20\u53C2",depth:2},{id:"usevumeterprops",text:"UseVuMeterProps",depth:3},{id:"\u8FD4\u56DE\u503C",text:"\u8FD4\u56DE\u503C",depth:2},{id:"object",text:"Object",depth:3}],b="useVuMeter";function o(i){const e=Object.assign({h1:"h1",a:"a",code:"code",p:"p",h2:"h2",h3:"h3",ul:"ul",li:"li",strong:"strong"},i.components);return r(c,{children:[r(e.h1,{id:"usevumeter",children:[n(e.a,{className:"header-anchor","aria-hidden":"true",href:"#usevumeter",children:"#"}),n(e.code,{children:"useVuMeter"})]}),`
`,n(e.p,{children:"\u7528\u4E8E\u83B7\u53D6\u97F3\u9891\u97F3\u91CF\u7684 Hook"}),`
`,r(t,{href:"https://github.com/codeacme17/echo-ui/blob/main/packages/hooks/useVuMeter.ts",target:"_blank",size:"sm",className:"flex items-center",children:[n(l,{className:"w-4 h-4"}),n("span",{className:"ml-2",children:"\u67E5\u770B\u6E90\u7801"})]}),`
`,r(e.h2,{id:"\u5F15\u5165",children:[n(e.a,{className:"header-anchor","aria-hidden":"true",href:"#\u5F15\u5165",children:"#"}),"\u5F15\u5165"]}),`
`,n(d,{code:"import { useVuMeter, type UseVuMeterProps } form 'echo-ui'"}),`
...
`]}),`
`]})]})}function g(i={}){const{wrapper:e}=i.components||{};return e?n(e,Object.assign({},i,{children:n(o,i)})):o(i)}const v="2024/1/24 15:43:27",f=`import { CodeBlock } from '../../src/components/CodeBlock.tsx'\r
...
\r
  \u51FA\u9519\u7684\u9519\u8BEF\u4FE1\u606F\r
`;export{f as content,g as default,p as frontmatter,v as lastUpdatedTime,b as title,m as toc};
