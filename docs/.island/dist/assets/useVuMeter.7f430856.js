import{jsx as n,jsxs as r,Fragment as o}from"react/jsx-runtime";import{C as l}from"./CodeBlock.913859b9.js";import{l as c,G as a}from"./github.6e7f8090.js";import"react";const m=void 0,p=[{id:"import",text:"Import",depth:2},{id:"parameters",text:"Parameters",depth:2},{id:"usevumeterprops",text:"UseVuMeterProps",depth:3},{id:"return-value",text:"Return Value",depth:2},{id:"object",text:"Object",depth:3}],b="useVuMeter";function i(t){const e=Object.assign({h1:"h1",a:"a",code:"code",p:"p",h2:"h2",h3:"h3",ul:"ul",li:"li",strong:"strong"},t.components);return r(o,{children:[r(e.h1,{id:"usevumeter",children:[n(e.a,{className:"header-anchor","aria-hidden":"true",href:"#usevumeter",children:"#"}),n(e.code,{children:"useVuMeter"})]}),`
`,n(e.p,{children:"A Hook for obtaining audio volume levels"}),`
`,r(c,{href:"https://github.com/codeacme17/echo-ui/blob/main/packages/hooks/useVuMeter.ts",target:"_blank",size:"sm",className:"flex items-center",children:[n(a,{className:"w-4 h-4"}),n("span",{className:"ml-2",children:"View Source"})]}),`
...
`,r(e.p,{children:["Initially constructed ",n(e.a,{href:"https://tonejs.github.io/docs/14.7.77/Meter",target:"_blank",rel:"nofollow",children:"Tone.Meter"}),"(Mono) or ",n(e.a,{href:"https://tonejs.github.io/docs/14.7.77/Split",target:"_blank",rel:"nofollow",children:"Tone.Split"}),"(Stereo) instances"]}),`
`]}),`
`,r(e.li,{children:[`
...
`]}),`
`]})]})}function g(t={}){const{wrapper:e}=t.components||{};return e?n(e,Object.assign({},t,{children:n(i,t)})):i(t)}const v="2024/1/24 15:43:27",f=`import { CodeBlock } from '../../src/components/CodeBlock.tsx'\r
...
`;export{f as content,g as default,m as frontmatter,v as lastUpdatedTime,b as title,p as toc};
