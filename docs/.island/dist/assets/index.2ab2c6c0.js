import{jsxs as ee,jsx as L}from"react/jsx-runtime";import{forwardRef as te,useImperativeHandle as re,useEffect as S,useState as E,useRef as $,useCallback as ae,useMemo as se}from"react";import{v as B,h as V,c as p}from"./index.105c25bf.js";import{A as oe}from"./index.41c546b7.js";import{_ as ne}from"./assertion.e9357fda.js";import{l as C}from"./log.83f32a09.js";import{s as ie}from"./index.93441784.js";import{u as le}from"./useCommandAltClick.cec7174c.js";const ue=({value:d,min:h,max:i})=>{if(!!ne)return d>i&&C.warn(`Slider - value(${d}) is higher than max(${i})`),d<h&&C.warn(`Slider - value(${d}) is lower than min(${h})`),!0},de=ie({slots:{base:`group
    text-foreground
    w-full
    h-2
    cursor-pointer
