...
export interface SliderRef extends HTMLDivElement {}`})]})}function R(i={}){const{wrapper:e}=i.components||{};return e?n(e,Object.assign({},i,{children:n(r,i)})):r(i)}const H="2024/1/23 17:02:29",U=`import { CodeBlock } from '../../src/components/CodeBlock.tsx'
import {
  Default,
  Disabled,
  Vertical,
