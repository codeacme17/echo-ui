import{U as c,m as o,A as a,c as e}from"./index.b8f1e832.js";import{jsx as t}from"react/jsx-runtime";const l=()=>t(c,{code:"<Switch> Switch </Switch>",scope:{Switch:o}}),r=()=>t(c,{code:"<Switch toggled> Toggled </Switch>",scope:{Switch:o}}),h=()=>t(c,{code:"<Switch disabled> Disabled </Switch>",scope:{Switch:o}}),u=()=>t(c,{code:`<div className="flex gap-6 items-center">
