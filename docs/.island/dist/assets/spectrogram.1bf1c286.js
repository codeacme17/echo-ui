...
`,a(n,{code:"import { Spectrogram } from 'echo-ui'"}),`
...
`,r(t,{code:"import { Spectrogram } from '@nafr/echo-ui'"}),`
...
>>>>>>>> main:docs/.island/dist/assets/spectrogram.8fefb202.js
  frequency: number 
  amplitude: number 
}`}),`
...
`})]})}function Q(n={}){const{wrapper:e}=n.components||{};return e?r(e,Object.assign({},n,{children:r(i,n)})):i(n)}const R="2024/3/15 13:46:55",X=`import { CodeBlock } from '../../src/components/CodeBlock.tsx'\r
