...
`,a(n,{code:`export interface SpectrogramProps extends React.HTMLAttributes<HTMLDivElement> {
...
`})]})}function Q(t={}){const{wrapper:e}=t.components||{};return e?a(e,Object.assign({},t,{children:a(i,t)})):i(t)}const R="2024/1/15 18:54:36",X=`import { CodeBlock } from '../../src/components/CodeBlock.tsx'
