...
`,r(i,{code:"import { Light } from '@nafr/echo-ui'"}),`
...
export interface LightRef extends HTMLDivElement {}`})]})}function N(t={}){const{wrapper:e}=t.components||{};return e?r(e,Object.assign({},t,{children:r(h,t)})):h(t)}const P="2024/3/15 13:46:55",I=`import {\r
  DefaultLight,\r
  OnLight,\r
  ColorLight,\r
  SizeLight,\r
