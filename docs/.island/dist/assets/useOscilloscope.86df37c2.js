import{jsx as n,jsxs as r,Fragment as a}from"react/jsx-runtime";import{C as c}from"./CodeBlock.de027be4.js";import{G as t}from"./github.54c71331.js";import{l}from"./chunk-MPX6TMFQ.dc1d8ff0.js";import"react";import"./index.2d091e0a.js";const g=void 0,f=[{id:"import",text:"import",depth:2},{id:"parameters",text:"Parameters",depth:2},{id:"useoscilloscopeprops",text:"UseOscilloscopeProps",depth:3},{id:"return-value",text:"Return Value",depth:2},{id:"object",text:"Object",depth:3}],b="useOscilloscope";function o(i){const e=Object.assign({h1:"h1",a:"a",code:"code",p:"p",h2:"h2",h3:"h3",ul:"ul",li:"li",strong:"strong"},i.components);return r(a,{children:[r(e.h1,{id:"useoscilloscope",children:[n(e.a,{className:"header-anchor","aria-hidden":"true",href:"#useoscilloscope",children:"#"}),n(e.code,{children:"useOscilloscope"})]}),`
`,n(e.p,{children:"A hook for creating an oscilloscope, which can obtain real-time amplitude data."}),`
`,r(l,{href:"https://github.com/codeacme17/echo-ui/blob/main/packages/hooks/useOscilloscope.ts",target:"_blank",size:"sm",className:"flex items-center",children:[n(t,{className:"w-4 h-4"}),n("span",{className:"ml-2",children:"View Source Code"})]}),`
...
`,r(e.p,{children:["After initialization, a ",n(e.code,{children:"waveform"})," type analyzer ",n(e.a,{href:"https://tonejs.github.io/docs/14.7.77/Analyser",target:"_blank",rel:"nofollow",children:"Tone.Analyser"})," instance is constructed."]}),`
`]}),`
`,r(e.li,{children:[`
...
`]}),`
`]})]})}function k(i={}){const{wrapper:e}=i.components||{};return e?n(e,Object.assign({},i,{children:n(o,i)})):o(i)}const v="2024/1/29 16:05:29",y=`import { CodeBlock } from '../../src/components/CodeBlock.tsx'\r
...
>\r
  ...
  <span className="ml-2">View Source Code</span>\r
</Link>\r
\r
## import\r
\r
...
\r
  After initialization, a \`waveform\` type analyzer [Tone.Analyser](https://tonejs.github.io/docs/14.7.77/Analyser) instance is constructed.\r
\r
