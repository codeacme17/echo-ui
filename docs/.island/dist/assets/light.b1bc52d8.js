...
`,t(i,{code:"import { Light } from '@nafr/echo-ui'"}),`
...
export interface LightRef extends HTMLDivElement {}`})]})}function S(n={}){const{wrapper:e}=n.components||{};return e?t(e,Object.assign({},n,{children:t(a,n)})):a(n)}const A="2024/3/15 13:46:55",M=`import {\r
  DefaultLight,\r
  OnLight,\r
  ColorLight,\r
  SizeLight,\r
...
## Import\r
\r
<CodeBlock code={\`import { Light } from '@nafr/echo-ui'\`} />\r
\r
## Usage\r
\r
<DefaultLight />\r
