...
export interface SliderRef extends HTMLDivElement {}`})]})}function H(t={}){const{wrapper:e}=t.components||{};return e?r(e,Object.assign({},t,{children:r(a,t)})):a(t)}const U="2024/1/14 18:30:40",w=`import { CodeBlock } from '../../src/components/CodeBlock.tsx'\r
import {\r
  Default,\r
  Disabled,\r
  Vertical,\r
...
`;export{w as content,H as default,L as frontmatter,U as lastUpdatedTime,R as title,B as toc};
