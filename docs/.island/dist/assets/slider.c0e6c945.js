...
export interface SliderRef extends HTMLDivElement {}`})]})}function F(i={}){const{wrapper:e}=i.components||{};return e?n(e,Object.assign({},i,{children:n(r,i)})):r(i)}const G="2024/1/23 17:02:29",W=`import { CodeBlock } from '../../src/components/CodeBlock.tsx'
import {
  Default,
  Disabled,
  Vertical,
