import{jsx as n,jsxs as r,Fragment as t}from"react/jsx-runtime";import{C as o}from"./CodeBlock.913859b9.js";import{l as d,G as c}from"./github.6e7f8090.js";import"react";const p=void 0,m=[{id:"import",text:"Import",depth:2},{id:"parameters",text:"Parameters",depth:2},{id:"useplayerprops",text:"UsePlayerProps",depth:3},{id:"return-values",text:"Return Values",depth:2},{id:"object",text:"Object",depth:3}],f="usePlayer";function l(i){const e=Object.assign({h1:"h1",a:"a",code:"code",p:"p",h2:"h2",h3:"h3",ul:"ul",li:"li",strong:"strong",div:"div"},i.components);return r(t,{children:[r(e.h1,{id:"useplayer",children:[n(e.a,{className:"header-anchor","aria-hidden":"true",href:"#useplayer",children:"#"}),n(e.code,{children:"usePlayer"})]}),`
...
`]}),`
`]})]})}function b(i={}){const{wrapper:e}=i.components||{};return e?n(e,Object.assign({},i,{children:n(l,i)})):l(i)}const g="2024/1/24 14:43:22",y=`import { CodeBlock } from '../../src/components/CodeBlock.tsx'\r
...
\r
  The error message.\r
`;export{y as content,b as default,p as frontmatter,g as lastUpdatedTime,f as title,m as toc};
