import{jsx as e,jsxs as r,Fragment as o}from"react/jsx-runtime";import{C as l}from"./CodeBlock.69bc42b0.js";import{l as d,G as h}from"./github.b0bde753.js";import"react";const u=void 0,m=[{id:"\u5F15\u5165",text:"\u5F15\u5165",depth:2},{id:"\u4F20\u53C2",text:"\u4F20\u53C2",depth:2},{id:"useplayerprops",text:"UsePlayerProps",depth:3},{id:"\u8FD4\u56DE\u503C",text:"\u8FD4\u56DE\u503C",depth:2},{id:"object",text:"Object",depth:3}],b="usePlayer";function c(i){const n=Object.assign({h1:"h1",a:"a",code:"code",p:"p",h2:"h2",h3:"h3",ul:"ul",li:"li",strong:"strong"},i.components);return r(o,{children:[r(n.h1,{id:"useplayer",children:[e(n.a,{className:"header-anchor","aria-hidden":"true",href:"#useplayer",children:"#"}),e(n.code,{children:"usePlayer"})]}),`
`,e(n.p,{children:"\u7528\u8BE5 Hook \u53EF\u4EE5\u5B9E\u73B0\u97F3\u4E50\u64AD\u653E\u5668\u7684\u57FA\u672C\u529F\u80FD\uFF0C\u5305\u62EC\u64AD\u653E\u3001\u6682\u505C\u3001\u64AD\u653E\u8FDB\u5EA6\u3001\u64AD\u653E\u6A21\u5F0F\u7B49"}),`
`,r(d,{href:"https://github.com/codeacme17/echo-ui/blob/main/packages/hooks/usePlayer.ts",target:"_blank",size:"sm",className:"flex items-center",children:[e(h,{className:"w-4 h-4"}),e("span",{className:"ml-2",children:"\u67E5\u770B\u6E90\u7801"})]}),`
`,r(n.h2,{id:"\u5F15\u5165",children:[e(n.a,{className:"header-anchor","aria-hidden":"true",href:"#\u5F15\u5165",children:"#"}),"\u5F15\u5165"]}),`
`,e(l,{code:"import { usePlayer, type UsePlayerProps } form 'echo-ui'"}),`
...
`,r(n.p,{children:["\u97F3\u9891\u7F13\u51B2\u533A\uFF0C\u53EF\u4EE5\u901A\u8FC7 ",e(d,{href:"/zh/hook/useFetchAudio",children:"useFetchAudio"})," hook \u83B7\u53D6"]}),`
`]}),`
`,r(n.li,{children:[`
`,r(n.p,{children:[e(n.strong,{children:"chain"}),": ",e(n.code,{children:"AudioNode[]"})]}),`
`,r(n.p,{children:["\u97F3\u9891\u8282\u70B9\u94FE\uFF0C\u8FDE\u63A5\u7684\u8282\u70B9\u4F1A\u5728\u64AD\u653E\u65F6\u4F9D\u6B21\u6267\u884C\uFF0C",r(n.strong,{children:["\u6CE8\u610F\u4E0D\u9700\u8981\u5728\u6700\u540E\u52A0\u5165 ",e(n.code,{children:"Tone.Destination"})," \u8282\u70B9"]})," \u3002\u5982\u4E0B\u4EE3\u7801\u6240\u793A\uFF0C\u8FDE\u63A5\u4E86\u4E00\u4E2A ",e(n.code,{children:"filter"})," \u8282\u70B9\u548C\u4E00\u4E2A ",e(n.code,{children:"analyser"})," \u8282\u70B9"]}),`
`,e(l,{code:"usePlayer({ audioBuffer, chain: [filter, analyser] })"}),`
`]}),`
`,r(n.li,{children:[`
...
`,r(n.ul,{children:[`
`,r(n.li,{children:[`
`,r(n.p,{children:[e(n.strong,{children:"player"}),": ",e(n.code,{children:"Tone.Player"})]}),`
`,r(n.p,{children:["\u521D\u59CB\u5316\u540E\u6784\u5EFA\u7684 ",e(n.a,{href:"https://tonejs.github.io/docs/14.7.77/Player",target:"_blank",rel:"nofollow",children:"Tone.Player"})," \u5B9E\u4F8B"]}),`
`]}),`
`,r(n.li,{children:[`
`,r(n.p,{children:[e(n.strong,{children:"audioDuration"}),": ",e(n.code,{children:"number"})]}),`
`,e(n.p,{children:"\u97F3\u9891\u7684\u65F6\u957F\uFF0C\u5355\u4F4D\u4E3A\u79D2"}),`
`]}),`
`,r(n.li,{children:[`
...
`,e(n.p,{children:"\u9519\u8BEF\u4FE1\u606F"}),`
`]}),`
`]})]})}function g(i={}){const{wrapper:n}=i.components||{};return n?e(n,Object.assign({},i,{children:e(c,i)})):c(i)}const f="2024/1/22 12:01:10",y=`import { CodeBlock } from '../../src/components/CodeBlock.tsx'
...
- **chain**: \`AudioNode[]\`
  ...
  \u97F3\u9891\u8282\u70B9\u94FE\uFF0C\u8FDE\u63A5\u7684\u8282\u70B9\u4F1A\u5728\u64AD\u653E\u65F6\u4F9D\u6B21\u6267\u884C\uFF0C**\u6CE8\u610F\u4E0D\u9700\u8981\u5728\u6700\u540E\u52A0\u5165 \`Tone.Destination\` \u8282\u70B9** \u3002\u5982\u4E0B\u4EE3\u7801\u6240\u793A\uFF0C\u8FDE\u63A5\u4E86\u4E00\u4E2A \`filter\` \u8282\u70B9\u548C\u4E00\u4E2A \`analyser\` \u8282\u70B9
...
- **errorMessage**: \`string\`
  ...
  \u9519\u8BEF\u4FE1\u606F
`;export{y as content,g as default,u as frontmatter,f as lastUpdatedTime,b as title,m as toc};
