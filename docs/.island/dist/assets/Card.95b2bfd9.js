...
</Card>`,scope:{Card:t}}),S=()=>e(c,{code:`<Card toggled>
  <Card.Header> 
...
</Card>`,scope:{Card:t,Light:n}}),B=()=>e(c,{code:"<CardActualScenario />",scope:{CardActualScenario:y},type:"link",url:"https://github.com/codeacme17/echo-ui/blob/main/docs/src/components/Example/CardActualScenario.tsx"}),H=()=>e(v,{data:[{attribute:"toggled",description:"Is the card activated",type:e(i,{children:"boolean"}),default:e(i,{children:"false"})}]});export{B as A,H as C,A as D,S as T};
