import{jsx as n,jsxs as r,Fragment as o}from"react/jsx-runtime";import{C as d}from"./CodeBlock.f3a900da.js";import{l as t,G as h}from"./github.e4a0b0ac.js";import"react";const u=void 0,m=[{id:"\u5F15\u5165",text:"\u5F15\u5165",depth:2},{id:"\u4F20\u53C2",text:"\u4F20\u53C2",depth:2},{id:"usefetchaudioprops",text:"UseFetchAudioProps",depth:3},{id:"\u8FD4\u56DE\u503C",text:"\u8FD4\u56DE\u503C",depth:2},{id:"object",text:"Object",depth:3}],f="useFetchAudio";function i(c){const e=Object.assign({h1:"h1",a:"a",code:"code",p:"p",h2:"h2",h3:"h3",ul:"ul",li:"li",strong:"strong"},c.components);return r(o,{children:[r(e.h1,{id:"usefetchaudio",children:[n(e.a,{className:"header-anchor","aria-hidden":"true",href:"#usefetchaudio",children:"#"}),n(e.code,{children:"useFetchAudio"})]}),`
...
`]}),`
`,r(e.li,{children:[`
`,r(e.p,{children:[n(e.strong,{children:"arrayBuffer"}),": ",n(e.code,{children:"ArrayBuffer"})]}),`
...
`]}),`
`]})]})}function g(c={}){const{wrapper:e}=c.components||{};return e?n(e,Object.assign({},c,{children:n(i,c)})):i(c)}const b="2024/1/16 20:29:14",k=`import { CodeBlock } from '../../src/components/CodeBlock.tsx'\r
...
\r
  \u8BF7\u6C42\u7684\u5B8C\u6574\u54CD\u5E94\r
`;export{k as content,g as default,u as frontmatter,b as lastUpdatedTime,f as title,m as toc};
