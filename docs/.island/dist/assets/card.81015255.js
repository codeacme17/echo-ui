import{jsx as r,jsxs as t,Fragment as o}from"react/jsx-runtime";import{D as i,T as c,A as s,C as l}from"./Card.f155fcd3.js";import{C as n}from"./CodeBlock.3473f527.js";import"./index.1dc66bc0.js";import"react";import"../client-entry.js";import"react-dom";const T=void 0,H=[{id:"import",text:"Import",depth:2},{id:"usage",text:"Usage",depth:2},{id:"active-state",text:"Active State",depth:3},{id:"real-world-scenario",text:"Real-World Scenario",depth:3},{id:"api",text:"API",depth:2},{id:"card",text:"Card",depth:3},{id:"type-declarations",text:"Type Declarations",depth:2}],D="Card";function d(a){const e=Object.assign({h1:"h1",a:"a",h2:"h2",h3:"h3"},a.components);return t(o,{children:[t(e.h1,{id:"card",children:[r(e.a,{className:"header-anchor","aria-hidden":"true",href:"#card",children:"#"}),"Card"]}),`
...
`})]})}function M(a={}){const{wrapper:e}=a.components||{};return e?r(e,Object.assign({},a,{children:r(d,a)})):d(a)}const g="2024/1/14 18:55:37",A=`import { Default, Toggled, ActualScenario } from '../../src/components/UsageBox/Card.tsx'\r
...
\`} />\r
`;export{A as content,M as default,T as frontmatter,g as lastUpdatedTime,D as title,H as toc};
