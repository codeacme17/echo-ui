import{jsx as n,jsxs as r,Fragment as i}from"react/jsx-runtime";import{C as c}from"./CodeBlock.913859b9.js";import{l as d,G as h}from"./github.6e7f8090.js";import"react";const p=void 0,m=[{id:"import",text:"Import",depth:2},{id:"parameters",text:"Parameters",depth:2},{id:"usefetchaudioprops",text:"UseFetchAudioProps",depth:3},{id:"return-value",text:"Return Value",depth:2},{id:"object",text:"Object",depth:3}],f="useFetchAudio";function o(t){const e=Object.assign({h1:"h1",a:"a",code:"code",p:"p",h2:"h2",h3:"h3",ul:"ul",li:"li",strong:"strong"},t.components);return r(i,{children:[r(e.h1,{id:"usefetchaudio",children:[n(e.a,{className:"header-anchor","aria-hidden":"true",href:"#usefetchaudio",children:"#"}),n(e.code,{children:"useFetchAudio"})]}),`
`,n(e.p,{children:"A Hook for fetching audio data, returns an object containing the request status and audio data."}),`
`,r(d,{href:"https://github.com/codeacme17/echo-ui/blob/main/packages/hooks/useFetchAudio.ts",target:"_blank",size:"sm",className:"flex items-center",children:[n(h,{className:"w-4 h-4"}),n("span",{className:"ml-2",children:"View Source"})]}),`
...
`]}),`
`]})]})}function g(t={}){const{wrapper:e}=t.components||{};return e?n(e,Object.assign({},t,{children:n(o,t)})):o(t)}const b="2024/1/17 09:08:44",q=`import { CodeBlock } from '../../src/components/CodeBlock.tsx'
