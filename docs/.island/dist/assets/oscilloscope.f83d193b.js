import{jsxs as s,jsx as e,Fragment as C}from"react/jsx-runtime";import{C as f}from"./CodeBlock.15abbd2c.js";import{H as E,s as P,U as y}from"./index.88984242.js";import{P as F}from"./index.5a6550a4.js";import*as a from"react";import{A as B}from"./Analyser.93bf318f.js";import{A as R,c}from"./index.55340fb1.js";import"react-dom";import"./_commonjsHelpers.4e997714.js";const T=()=>{const r="https://codeacme17.github.io/1llest-waveform-vue/audios/loop-5.mp3",[t,d]=a.useState([]),[u,p]=a.useState(!1),l=a.useRef(),n=a.useRef(null),x=512*2;a.useEffect(()=>(n.current=new F(r),l.current=new B("waveform",x),n.current.toDestination(),()=>{var o,i;(o=n.current)==null||o.disconnect(),(i=n.current)==null||i.dispose()}),[]);const O=async()=>{var o;if(!n.current||!l.current){console.error("Oscillator or Analyser is not initialized");return}u?(n.current.stop(),cancelAnimationFrame(m.current),d([]),p(!1)):((o=n.current)==null||o.connect(l.current),n.current.loop=!0,n.current.start(),p(!0),h())},m=a.useRef(0),h=()=>{var i;const o=(i=l.current)==null?void 0:i.getValue();if(o instanceof Float32Array){const g=Array.from(o).map((A,D)=>({index:D,amplitude:A}));d(g)}m.current=requestAnimationFrame(h)};return s("section",{className:"flex flex-col items-center gap-2",children:[e(E,{className:"w-full",data:t}),e(P,{onClick:O,toggled:u,children:u?"Stop":"Start"})]})},I=()=>e(y,{code:"<OscilloscopeDefault />",scope:{OscilloscopeDefault:T},type:"link",url:"https://github.com/codeacme17/echo-ui/blob/main/docs/src/components/Example/OscilloscopeDefault.tsx"}),k=()=>e(R,{data:[{attribute:"data",description:"\u4F20\u9012\u7ED9\u793A\u6CE2\u5668\u7684\u6570\u7EC4\u6570\u636E",type:e(c,{children:"OscilloscopeDataPoint[]"}),default:"-"},{attribute:"amplitudeRange",description:"\u632F\u5E45\u8303\u56F4\uFF0C\u8BE5\u5C5E\u6027\u53EF\u4EE5\u6307\u5B9A Y \u8F74\u7684\u8303\u56F4",type:e(c,{children:"[number, number]"}),default:e(c,{children:" [-2, 2]"})},{attribute:"lineColor",description:"\u793A\u6CE2\u5668\u7684\u7EBF\u6761\u989C\u8272",type:e(c,{children:"string"}),default:e(c,{children:"'var(--echo-primary)'"})},{attribute:"lineWidth",description:"\u793A\u6CE2\u5668\u7684\u7EBF\u6761\u5BBD\u5EA6",type:e(c,{children:"number"}),default:e(c,{children:"3"})}]}),U=void 0,W=[{id:"\u5F15\u5165",text:"\u5F15\u5165",depth:2},{id:"\u4EE3\u7801\u6F14\u793A",text:"\u4EE3\u7801\u6F14\u793A",depth:2},{id:"api",text:"API",depth:2},{id:"\u7C7B\u578B\u58F0\u660E",text:"\u7C7B\u578B\u58F0\u660E",depth:2}],_="Oscilloscope \u793A\u6CE2\u5668";function b(r){const t=Object.assign({h1:"h1",a:"a",p:"p",h2:"h2"},r.components);return s(C,{children:[s(t.h1,{id:"oscilloscope-\u793A\u6CE2\u5668",children:[e(t.a,{className:"header-anchor","aria-hidden":"true",href:"#oscilloscope-\u793A\u6CE2\u5668",children:"#"}),"Oscilloscope \u793A\u6CE2\u5668"]}),`
...
`})]})}function q(r={}){const{wrapper:t}=r.components||{};return t?e(t,Object.assign({},r,{children:e(b,r)})):b(r)}const z="2024/1/10 10:10:15",X=`import { CodeBlock } from '../../src/components/CodeBlock.tsx'\r
...
\`} />\r
`;export{X as content,q as default,U as frontmatter,z as lastUpdatedTime,_ as title,W as toc};
