...
export const AXIS_COLOR = 'var(--echo-muted-foreground)'
export const X_AXIS_TICKS = [50, 100, 200, 500, 1000, 2000, 5000, 10000]
export const Y_AXIS_TICKS = [-80, -60, -20, 0]

export const LINE_WIDTH = 2
export const LINE_COLOR = 'var(--echo-primary)'

export const GRID_COLOR = 'var(--echo-background)'
